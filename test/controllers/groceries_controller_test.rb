...
class GroceriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grocery" do
    assert_difference("Grocery.count") do
      post groceries_url, params: { grocery: { address: @grocery.address, name: @grocery.name, rating: @grocery.rating } }
    end
  ...
  test "should update grocery" do
    patch grocery_url(@grocery), params: { grocery: { address: @grocery.address, name: @grocery.name, rating: @grocery.rating } }
